...
const CardDeEventos = ({id, imagem, nome, organizacao, coordenador, status, edicoes, footer}: Props) => {
    return (
        <div className="card border-3 mb-4" style={{borderColor: "#011826"}}>
            ...
            <div className="d-flex flex-row p-1">
                <img src={imagem} className="card-img" style={{width: "50%", height: "50%"}} />
